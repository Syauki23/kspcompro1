  ...
  <section class="pod-platforms">
    <div class="pod-plat-container">
      ...
      <div class="pod-plat-links">
        ...
        @endif
        @if(isset($settings['podcast_youtube_url']) && $settings['podcast_youtube_url'])
        <a href="{{ $settings['podcast_youtube_url'] }}" class="plat-link" target="_blank">
          <svg viewBox="0 0 24 24" width="32" height="32" fill="#FF0000"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
          <div class="plat-text">
            <span>YouTube</span>
