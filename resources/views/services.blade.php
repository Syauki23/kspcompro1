  ...
  <div class="services-hero-container">
    <div class="services-hero-content">
      ...
      <p class="services-desc">
        KSP Consulting provides integrated consulting services to help maritime
        and industrial businesses overcome challenges and achieve sustainable
  ...
  <div class="services-container">
    ...
    <div class="services-stats-banner">
      <div class="stat-item">
        ...
        <div class="stat-text"><h4>15+</h4><p>Ship Management<br>Entities Assessed</p></div>
      </div>
      <div class="stat-item">
        ...
        <div class="stat-text"><h4>Since 2017</h4><p>Maritime Assessment &<br>Consulting Experience</p></div>
      </div>
      <div class="stat-item">
        ...
        <div class="stat-text"><h4>Multiple</h4><p>TMSA Gap Assessments &<br>Implementations</p></div>
      </div>
      <div class="stat-item">
        ...
        <div class="stat-text"><h4>Trusted</h4><p>By Leading Maritime &<br>Industrial Organizations</p></div>
      </div>
    </div>
  </div>
</section>
