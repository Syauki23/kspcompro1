    ...
    <div class="about-text-col">
      ...
      <div class="about-stats">
        ...
        <div class="about-stat-item">
          ...
          <h4>{{ $settings['about_stat_3_num'] ?? 'Multiple' }}</h4>
          <p>{{ $settings['about_stat_3_label'] ?? 'Industries Served Across Indonesia' }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="about-image-col">
      <div class="about-img-grid">
        ...
        <div class="about-img item-man-ship">
         <img src="{{ isset($settings['about_image_2']) ? (str_starts_with($settings['about_image_2'], 'http') || str_starts_with($settings['about_image_2'], 'assets') ? asset($settings['about_image_2']) : Storage::url($settings['about_image_2'])) : asset('assets/uuuaaa.png') }}" alt="About Image 2">
        </div>
        <div class="about-img item-hard-hats">
         <img src="{{ isset($settings['about_image_3']) ? (str_starts_with($settings['about_image_3'], 'http') || str_starts_with($settings['about_image_3'], 'assets') ? asset($settings['about_image_3']) : Storage::url($settings['about_image_3'])) : asset('assets/uuu.png') }}" alt="About Image 3">
        </div>
        <div class="about-img item-woman-laptop">
         <img src="{{ isset($settings['about_image_4']) ? (str_starts_with($settings['about_image_4'], 'http') || str_starts_with($settings['about_image_4'], 'assets') ? asset($settings['about_image_4']) : Storage::url($settings['about_image_4'])) : asset('assets/about.png') }}" alt="About Image 4">
        </div>
        <div class="about-img item-ship-bridge">
          <img src="{{ isset($settings['about_image_5']) ? (str_starts_with($settings['about_image_5'], 'http') || str_starts_with($settings['about_image_5'], 'assets') ? asset($settings['about_image_5']) : Storage::url($settings['about_image_5'])) : 'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?auto=format&fit=crop&w=800&q=80' }}" alt="About Image 5">
        </div>
      </div>
    </div>
  ...
  <div class="core-values-wrapper">
    ...
    <div class="core-values-grid">
      ...
      <div class="value-item">
        ...
        <h4>{{ $settings['about_core_6_title'] ?? 'IMPACT' }}</h4>
        <p>{{ $settings['about_core_6_desc'] ?? 'We focus on creating sustainable impact that drives long-term growth.' }}</p>
      </div>
    </div>
  </div>
</section>
