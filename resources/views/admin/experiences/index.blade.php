...
@section('header_title', 'Experiences')
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Semua Experience</h3>
            <a href="{{ route('admin.experiences.create') }}" style="background: var(--accent-orange); color: white; padding: 8px 18px; border-radius: 8px; font-size: 13px; font-weight: 600; text-decoration: none;">+ Tambah</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 8px;">
                                    <a href="{{ route('admin.experiences.edit', $exp) }}" class="btn-secondary" style="padding: 6px 14px; font-size: 12px; text-decoration: none;">Edit</a>
